...
# 모델 경로
MODEL_PATH="/home2/ihmhyunsir/WorkingSpace/lab_proj/diffusion_imbalance/idv2/trained_model/model077500.pt"
# 베이스 저장 경로
BASE_SAVE_PATH="/home2/ihmhyunsir/WorkingSpace/lab_proj/diffusion_imbalance/idv2/sampled_images"
# 기타 플래그
...
do
    # 저장 경로 설정
    SAVE_PATH="${BASE_SAVE_PATH}/class_${CLASS_NUM}/"
